...
const TableProducts = ({ selectProduct }) => {
    ...
    <td className='px-6 py-4'><a href={`/products/${selectProduct.article}`}>{selectProduct.brand }</a></td>
    ...
    <td className="px-6 py-4"><a href={`/products/${selectProduct.article}`}>{selectProduct.category}</a></td>      
    </tr>      
      </>
