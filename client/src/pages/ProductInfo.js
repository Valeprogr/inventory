...
//console.log(selectProduct)
  ...
  const editSizeHandler = (event) => {
    ...
    fetch(`${process.env.REACT_APP_API_BASE_URL}shoes/editSizes/${itemArticle}`, requestOptions)
  ...
  useEffect(() => {
    fetch(`${process.env.REACT_APP_API_BASE_URL}shoes/shoesModel/${itemArticle}`)
      .then((response) => response.json())
